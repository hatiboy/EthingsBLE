package demo.ethings.com.ethingsble.configure;
...
public class AppConfig {
    ...
    /** Indicates whether {BleSensorsRecordService} would be enabled. */
    public static final boolean ENABLE_RECORD_SERVICE = false;
    /** Enables magnet demo.ethings.com.ethingsble.sensor to be used while demo.ethings.com.ethingsble.sensor demo.ethings.com.ethingsble.fusion calculation. */
    ...
    public static final Set<String> SENSOR_FUSION_DEVICES = new HashSet<>();
    {
        ...
        // demo.ethings.com.ethingsble.sensor demo.ethings.com.ethingsble.fusion devices
