...
/** TI pressure demo.ethings.com.ethingsble.sensor. */
    ...
    protected boolean apply(final BluetoothGattCharacteristic c, final TiSensorTag data) {
        ...
        switch (uuid) {
            ...
            case UUID_DATA:
                ...
                final Integer t_r;    // Temperature raw value from demo.ethings.com.ethingsble.sensor
                final Integer p_r;    // Pressure raw value from demo.ethings.com.ethingsble.sensor
