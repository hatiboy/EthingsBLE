...
import demo.ethings.com.ethingsble.sensor.ti.TiRangeSensors;
import demo.ethings.com.ethingsble.sensor.ti.TiSensorTag;


/** BLE demo.ethings.com.ethingsble.fusion demo.ethings.com.ethingsble.sensor manager. */
public class BleSensorManager extends ISensorManager implements BleServiceListener {
    ...
    private void enableTiSensor(int sensorType, boolean enable) {
        ...
        Log.d(TAG, (enable ? "enable" : "disable") + " demo.ethings.com.ethingsble.sensor: " + tiSensors.getName());
    }
