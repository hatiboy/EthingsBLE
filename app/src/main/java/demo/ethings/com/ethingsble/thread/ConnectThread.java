package demo.ethings.com.ethingsble.thread;
...
//        }
    ...
    public void run() {
        ...
        // the connection in a separate demo.ethings.com.ethingsble.thread.
    ...
    // Closes the client socket and causes the demo.ethings.com.ethingsble.thread to finish.
    public void cancel() {
        try {
            mmSocket.close();
        } catch (IOException e) {
